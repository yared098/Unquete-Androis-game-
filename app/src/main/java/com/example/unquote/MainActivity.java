...
public class MainActivity extends AppCompatActivity {
    ...
    private void onAnswerSelected(int answerSelected,Button button) {
        ...
        // make the button name add corrected icon
            ...
            button.setBackground(ContextCompat.getDrawable(MainActivity.this, R.drawable.buttoncorrect));
    ...
    private void onAnswerSubmission() {
        ...
        questions.remove(currentQuestion);
         // this code make  if user not selected the answer make visisble false
